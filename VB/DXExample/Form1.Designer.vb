...
#End Region
        Private myLayoutControl1 As DXExample.MyLayoutControl

        Private layoutControlGroup1 As DevExpress.XtraLayout.LayoutControlGroup

        Private myLayoutControlGroup1 As DXExample.MyLayoutControlGroup

        Private myLayoutControlGroup3 As DXExample.MyLayoutControlGroup

        Private myLayoutControlGroup2 As DXExample.MyLayoutControlGroup

        Private textEdit2 As DevExpress.XtraEditors.TextEdit

        Private textEdit1 As DevExpress.XtraEditors.TextEdit

        Private myLayoutControlItem1 As DXExample.MyLayoutControlItem

        Private myLayoutControlItem2 As DXExample.MyLayoutControlItem
    End Class
End Namespace
